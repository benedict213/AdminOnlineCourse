                                    ...
                                    <form role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="deskripsi" placeholder="masukan deskripsi">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">isi</label>
                                                <input type="password" class="form-control" name="isi" placeholder="masukan isi">
                                            </div>
